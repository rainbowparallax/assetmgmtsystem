...
<?php
    ...
    if($aval == 'Not Available') {
		...
		if(!mysqli_query($db, $sql1)) {
		    ...
		    $sql2 = "UPDATE asset SET `Availability`='Available' WHERE `AssetID` LIKE '$asset_id'";
			...
			if (mysqli_query($db, $sql2) && mysqli_query($db,$sql3)) {
	    		...
	    		echo 'Successfully Checked In the Asset!'; echo nl2br("\n"); echo nl2br("\n");
			}
			else {
	...
	elseif ($aval == 'Available') {
		echo "Asset is already Checked In"; echo nl2br("\n"); echo nl2br("\n"); 
	}
	else {
		echo "Error: Asset your trying to Check In is Invalid"; echo nl2br("\n"); echo nl2br("\n");
		echo "Contact Administrator"; echo nl2br("\n"); echo nl2br("\n");
	}
?>
</div>
<?php
	echo '<center><a href= "indexreturn.php">Return another Asset</a></center>'; echo nl2br("\n"); echo nl2br("\n");
?>
</body>
<br>
<footer>
